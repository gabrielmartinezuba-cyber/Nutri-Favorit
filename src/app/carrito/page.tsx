  ...
  if (isSuccess) {
    return (
      <div className="min-h-[calc(100vh-160px)] flex items-center justify-center px-4 bg-[#F5F0EB]">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center text-center gap-5 max-w-sm w-full">
          ...
          <p className="text-sm text-gray-500 font-medium leading-relaxed">
            Tu pedido ya fue enviado a preparación.
          </p>
          ...
          <a 
            ...
            className="w-full bg-[#25D366] text-white font-bold px-8 py-4 rounded-2xl shadow-xl transition-all active:scale-95 uppercase tracking-wider text-sm flex items-center justify-center gap-2 mt-2"
          >
            Finalizar pago por WhatsApp
          </a>

          <Link href="/" className="w-full bg-white text-gray-600 border border-gray-200 font-bold px-8 py-4 rounded-2xl shadow-sm transition-all active:scale-95 uppercase tracking-wider text-sm flex items-center justify-center gap-2">
